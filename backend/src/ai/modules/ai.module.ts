...
@Module({
  ...
  providers: [GeminiService, AgentService, MarkdownService, PromptSecurityService, AgentRunRepository, AgentOutputRepository, AgentRunLinkRepository, BrandProfileRepository],
  exports: [GeminiService, AgentService, MarkdownService, PromptSecurityService, AgentRunRepository, AgentOutputRepository, AgentRunLinkRepository, BrandProfileRepository],
